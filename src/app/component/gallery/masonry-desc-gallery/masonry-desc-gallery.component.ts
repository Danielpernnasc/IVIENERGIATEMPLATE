...
@Component({
  selector: 'app-masonry-desc-gallery',
  templateUrl: './masonry-desc-gallery.component.html',
  styleUrls: ['./masonry-desc-gallery.component.scss']
})
export class MasonryDescGalleryComponent {
