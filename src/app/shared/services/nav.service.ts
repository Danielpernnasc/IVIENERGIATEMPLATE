...
export class NavService {
  ...
  MENUITEM: Menu[] = [
    ...
    {
      link1: 'Cadastro',
      path: '/home-ivienergia/cadastro'
    
    },
    {
      link2: 'Configurações',
      path: '/home-ivienergia/configuracoes'
    },
    {
      link3: 'Consultas',
      path: '/home-ivienergia/consultas'
    },
    {
      link4: 'Menu',
      items: [
        {
          title: 'Pre-project',
          path: '/home-ivienergia/menu/PreCadastro'
         
        },
        {
          title: 'Pre-project por Lote',
          path: '/home-ivienergia/menu/PreCadastroLote'
        },
      ],
    },
    {
      link5: 'Relatório',
      path: '/home-ivienergia/relatorio'
    }
  ];
